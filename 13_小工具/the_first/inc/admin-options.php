...
/**
 * The First 主题由追格（www.zhuige.com）开发的一款免费开源的WordPress主题，专为WordPress博客、资讯、自媒体网站而设计。
 */

//
// Set a unique slug-like ID
//
$prefix = 'zhuige_the_first';
...
CSF::createOptions($prefix, array(
    'framework_title' => 'The First 主题 <small>by <a href="https://www.zhuige.com" target="_blank" title="The First">www.zhuige.com</a></small>',
    'menu_title' => 'The First 主题',
    'menu_slug'  => 'jiangqie-free',
    'menu_position' => 2,
    'show_bar_menu' => false,
    'show_sub_menu' => false,
    'footer_credit' => 'Thank you for creating with <a href="https://www.zhuige.com/" target="_blank">The First</a>',
    'menu_icon' => 'dashicons-layout',
));

$content = '欢迎使用The First 主题! <br/><br/> 微信客服：jianbing2011 (加开源群、问题咨询、项目定制、购买咨询) <br/><br/> <a href="https://www.zhuige.com/download.html" target="_blank">更多免费产品</a>';
